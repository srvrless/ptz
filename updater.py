...
def ensure_venv():
    ...
    if not python_path.exists():
        print("[*] Виртуальное окружение не найдено. Создаём...")
...
def start_agent():
    try:
        ...
        AMQP_URL = "amqp://corebus:corebus123@10.14.101.253:5672/%2F"
        ...
        channel.basic_consume(
            queue=queue_name, on_message_callback=process_update, auto_ack=True
        )
